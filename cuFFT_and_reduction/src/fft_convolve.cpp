...
#define STOP_RECORD_TIMER(name) {                           \
    ...
    for (int ch = 0; ch < nChannels; ch++){
        ...
        // Memory has already been reserved (malloced) for the 3 cufftComplex
        // arrays (dev_input_data, dev_impulse_v, dev_out_data) above
        ...
        */
        cufftHandle plan;
        int batch = 1; // number of transformations to run
